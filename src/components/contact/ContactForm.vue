...
<template>
  <form class="flex flex-col p-5 shadow-md rounded-lg bg-filter" id="form">
    <pv-input-group>
    ...
    <pv-button type="submit"
               class="px-5 py-3 text-sm" id="button-email"
